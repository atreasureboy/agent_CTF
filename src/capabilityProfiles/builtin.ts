...
export const PROFILES: Record<string, CapabilityProfile> = {
  ...
  'web': {
    ...
    description: 'Web 漏洞 Agent:服务发现( nmap 后台 )+ 路径枚举( gobuster )+ 漏洞扫描( nikto/sqlmap )+ HTTP 操作( curl )。',
    systemPromptModules: ['role.boundary', 'tool.first', 'web.protocol'],
    allowedTools: ['Read', 'Glob', 'Grep', 'Bash', 'TodoWrite', 'WebFetch',
      'load_skill', 'memory_search', 'memory_recall',
      'emit_finding', 'request_handoff', 'extract_artifact',
      'curl', 'nmap', 'nikto', 'sqlmap', 'gobuster',
      'list_artifacts', 'list_findings', 'list_jobs', 'query_background_job',
      'collect_background_result', 'inspect_artifact_summary', 'inspect_finding'],
  ...
  'traffic': {
    ...
    description: '流量分析 Agent:pcap 解析( tshark )+ 过滤导出( tcpdump )+ HTTP/TLS/对象提取 + 跨协议接力。',
    systemPromptModules: ['role.boundary', 'tool.first', 'traffic.protocol'],
    allowedTools: ['Read', 'Glob', 'Grep', 'Bash', 'TodoWrite',
      'load_skill', 'memory_search', 'memory_recall',
      'emit_finding', 'request_handoff', 'extract_artifact',
      'tshark', 'tcpdump', 'file', 'strings',
      'list_artifacts', 'list_findings', 'list_jobs', 'query_background_job',
      'collect_background_result', 'inspect_artifact_summary', 'inspect_finding'],
